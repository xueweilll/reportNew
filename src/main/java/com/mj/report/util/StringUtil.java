...
//		s = Replace(s, " ", "&nbsp;");
	...
	*/
	...
	public static void main(String[] args) {
		//System.out.println("-----\n"+classToTableName("SyyyyyBssssYssss"));
	}
	
	public static String ignoreSpecial(String input) {
		Pattern pa = Pattern.compile("[^\u4e00-\u9fa5a-zA-Z0-9]+");
	 ...
	 * @return
	 */
	public static boolean isNotBank(String... args) {
		for(String str:args) {
